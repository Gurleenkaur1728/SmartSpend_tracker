...
import { saveTransaction } from '../utils/storage'; // <-- change to your save fn if needed
...
export default function AddExpenseScreen() {
  ...
  const submit = async () => {
    ...
    try {
      await saveTransaction(tx); // <-- if your util is saveTransaction(tx), just change this line
      router.back();
    } catch (e) {
      ...
      <View style={{ paddingHorizontal: 16, gap: 16 }}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.segment}>
            <SegmentBtn text="Expense" active={type === 'expense'} onPress={() => setType('expense')} />
            <SegmentBtn text="Income" active={type === 'income'} onPress={() => setType('income')} />
          </View>
        </View>
        ...
        <View style={styles.grid2}>
          <View style={styles.card}>
            ...
            {/* If you want an actual picker later, I can wire one in. */}
          </View>
